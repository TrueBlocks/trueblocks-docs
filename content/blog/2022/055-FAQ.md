...
Version: chifra version GHC-TrueBlocks//0.64.0-beta
data source: from chifra scrape
commend: chifra scrape --fmt csv --logs 0x7a58c0be72be218b41c608b7fe7c5bb630736c71 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef > file.transfer.logs.csv

issue:
I'm trying to export all transfers of people token on etherium, I filtered by contract address and topic, but the result contains transfer of other token.
Take a look at tx: 0xf8c514b5e0df0338536b70aa7de85dda4ac8426f9a1f95aedc24889413ca23f5

图片

You can see erc20 transfer of other token in this transaction is also exported. This is confusing and would add extra size to the file.
